...
function AgentCard({ agent }: { agent: Agent }) {
  ...
  return (
    <Link
      href={`/agents/${agent.slug ?? toAgentSlug(agent.full_name)}`}
    ...
    (async () => {
      ...
      const [
        ...
        supabase
          ...
          .neq("account_type", "administrator")
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 py-10">
        ...
        <Breadcrumb items={[{ label: "Agents" }]} className="mb-8" />
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          ...
          >
            ...
            <option value="agencija">Agencies</option>
            <option value="fizicna_oseba">Individuals</option>
          </select>
